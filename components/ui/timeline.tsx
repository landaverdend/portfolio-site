...
function Timeline({ className, orientation, color = 'secondary', children, ...props }: TimelineProps) {
  return (
...
function TimelineItem({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('relative flex gap-4 pb-8 last:pb-0', className)} {...props} />;
}

function TimelineHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('flex w-6 shrink-0 flex-col items-center', className)} {...props} />;
}
...
function TimelineSeparator({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return <div className={cn('absolute top-3 left-[11px] h-full w-0.5', colorClasses[color], className)} {...props} />;
}
...
function TimelineIcon({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      className={cn('relative z-10 flex size-6 items-center justify-center rounded-full', colorClasses[color], className)}
      {...props}>
      {children}
    </div>
  );
...
function TimelineBody({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('flex-1 pt-0.5', className)} {...props} />;
}

export { Timeline, TimelineItem, TimelineHeader, TimelineSeparator, TimelineIcon, TimelineBody, timelineVariants };
